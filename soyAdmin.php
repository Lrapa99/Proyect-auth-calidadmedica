...
<div class="logo"><h1>Lra<span class="text-primary">pa.</span></h1><a id="btn_admin" class="btn btn-primary" href="index.php" role="button">Soy Cliente</a>
</div>
...
<img src="./IMG/newAdmin.svg" alt="img_login" title="img_login" id="img__login">
</div>
